...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el pais de un atleta dado su nombre
	 * @param el nombre del atleta
	 * @return el pais del atleta
	 */
	public String buscarPaisPorNombre(String nombreAtleta) 
	{
		Atleta persona = buscarAtleta(nombreAtleta);
		Pais pais = persona.darPais();
