...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de un atleta segun el nombre");
		System.out.println("14. Salir de la aplicación\n");
	}

	
	/**
	 * le pide al usuario el nombre de un atleta y luego busca el pais al cual
	 * representa el atleta
	 */
	private void ejecutarBuscarPaisPorNombre() 
	{
		System.out.println("\n" + "Consultar el pais de un atleta segun el nombre" + "\n");
		String nombre =  input("por favor ingresar el nombre de atleta");
		String buscarNombre = calculadora.buscarPaisPorNombre(nombre);
		System.out.println("El pais de origen de " + nombre + " es: " + buscarNombre);
